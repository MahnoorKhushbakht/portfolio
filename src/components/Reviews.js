...
export default function Reviews(){
  ...
  <Box display="flex" justifyContent="center" alignItems="center" minHeight="100vh" marginTop='100px'  marginBottom='20px'>
    <Card backgroundColor='#F6F1EE' sx={{width: { base: '85%', sm: '80%', md: '60%', lg: '50%' }}}>
  <CardHeader>
    <Flex spacing='2'>
      <Flex flex='1' gap='2' alignItems='left' flexWrap='wrap'>
        <Avatar fontSize={{ base: "2px", md: "6px", lg: "6px" }} name='Promise Emmanuel' src={ClientImage} />
  ...
  <CardBody>
    <Text display='flex' alignContent='left' textAlign='left' fontSize={{ base: "12px", md: "12px", lg: "16px" }}>
